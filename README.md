...
**Doctor Info Scraper** is a Python project designed to crawl healthcare websites and extract publicly available doctor information. The scraper collects:

- Doctor names  
- Qualifications (MBBS, MD, PhD, etc.)  
- Specializations (Cardiologist, Dermatologist, etc.)  
- Public emails  
